...
public class Main {
    ...
    static void addMember() {
        try {
            ...
            String query = "INSERT INTO members(name, phone, plan) VALUES (?, ?, ?)";
    ...
    static void releaseLocker() {
        try {
            ...
            System.out.print("Enter Locker Number (e.g., Locker 01): ");
    ...
    static void viewStatus() {
        try {
            ...
            String query = "SELECT l.locker_no, m.name, m.phone, m.plan, l.assigned_on " +
                           "FROM lockers l LEFT JOIN members m " +
            ...
            while (rs.next()) {
                ...
                if (name == null) {
                    ...
                    System.out.println(
                        ...
                        " | Assigned: " + rs.getDate("assigned_on")
                    );
                }
            }
